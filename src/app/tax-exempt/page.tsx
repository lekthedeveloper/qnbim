            ...
            <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-[#f8fafc]">
                ...
                <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-20">
                    <div className="bg-white border border-slate-200 shadow-2xl rounded-sm overflow-hidden animate-in fade-in zoom-in duration-500">
                        <div className="h-2 w-full bg-teal-accent"></div>
                        <div className="p-16 text-center">
                            <div className="w-24 h-24 bg-teal-50 rounded-full flex items-center justify-center mx-auto mb-8 border-2 border-teal-100">
                                <span className="material-symbols-outlined text-5xl text-teal-accent">verified_user</span>
                            </div>
                            <h1 className="text-4xl font-black text-[#001A2C] uppercase tracking-tighter mb-4">Compliance Submission Received</h1>
                            ...
                            <div className="max-w-2xl mx-auto space-y-6 text-left border-y border-slate-100 py-10 my-10">
                                <div>
                                    <h4 className="text-[11px] font-black text-[#001A2C] uppercase tracking-widest mb-2 flex items-center gap-2">
                                        <span className="w-1.5 h-1.5 bg-teal-accent rounded-full"></span>
                                        Audit Registry
                                    </h4>
                                    <p className="text-sm text-[#001A2C] font-medium leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                ...
                                <button className="w-full sm:w-auto bg-white border border-slate-300 text-[#001A2C] px-10 py-4 text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 transition-all rounded-sm flex items-center justify-center gap-2">
    ...
    return (
        <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-[#f8fafc]">
            ...
            <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-16">
                <div className="mb-12">
                    <div className="inline-block bg-[#001A2C] text-white text-[10px] font-black px-3 py-1 rounded-sm uppercase tracking-widest mb-4">
                        Secure Document Portal
                    </div>
                    <h1 className="text-4xl font-black text-[#001A2C] uppercase tracking-tighter leading-none mb-4">Tax Exemption Setup</h1>
                    ...
                    <p className="text-[#001A2C] text-sm font-medium max-w-2xl opacity-70 italic">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white border border-slate-200 shadow-sm rounded-sm overflow-hidden">
                            <div className="p-10">
                                <h3 className="text-sm font-black text-[#001A2C] uppercase tracking-widest mb-6 flex items-center gap-3">
                                    <span className="w-1 h-6 bg-teal-accent block"></span>
                                ...
                                {certFile ? (
                                    <div className="bg-teal-50 border border-teal-100 p-8 rounded-sm flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center border border-teal-200">
                                                <span className="material-symbols-outlined text-teal-accent">description</span>
                                            </div>
                                            <div>
                                                <p className="text-[11px] font-black text-[#001A2C] uppercase tracking-tight flex items-center gap-2">
                                    ...
                                    <div
                                        ...
                                        className="border-2 border-dashed border-slate-100 rounded-sm p-12 text-center cursor-pointer hover:border-teal-accent/40 hover:bg-teal-50/20 transition-all group"
                                    >
                                        <span className="material-symbols-outlined text-4xl text-slate-300 group-hover:text-teal-accent mb-4 transition-colors">cloud_upload</span>
                                        <h4 className="text-xs font-black text-[#001A2C] uppercase tracking-widest mb-2">Upload State Certificate</h4>
                            ...
                            <div className="p-10">
                                ...
                                {w9File ? (
                                    <div className="bg-teal-50 border border-teal-100 p-8 rounded-sm flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center border border-teal-200">
                                                <span className="material-symbols-outlined text-teal-accent">history_edu</span>
                                            </div>
                                            <div>
                                                <p className="text-[11px] font-black text-[#001A2C] uppercase tracking-tight flex items-center gap-2">
                                    ...
                                    <div
                                        ...
                                        className="border-2 border-dashed border-slate-100 rounded-sm p-12 text-center cursor-pointer hover:border-teal-accent/40 hover:bg-teal-50/20 transition-all group"
                                    >
                                        <span className="material-symbols-outlined text-4xl text-slate-300 group-hover:text-teal-accent mb-4 transition-colors">upload_file</span>
                                        <h4 className="text-xs font-black text-[#001A2C] uppercase tracking-widest mb-2">Upload IRS Form W-9</h4>
                                        <p className="text-[10px] text-slate-400 font-bold uppercase">PDF, JPG, or PNG (MAX 10MB)</p>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className={`w-full py-5 text-xs font-black uppercase tracking-[0.2em] rounded-sm transition-all shadow-xl flex items-center justify-center gap-3 ${submitting || (!certFile && !w9File)
                                    ...
                                    : 'bg-teal-accent text-white hover:bg-teal-600 scale-100 hover:scale-[1.01] active:scale-95 shadow-teal-500/10'
                                    }`}
                            >
                                {submitting ? (
                                    <>
                    ...
                    <aside className="space-y-6">
                        <div className="bg-[#001A2C] text-white p-10 rounded-sm shadow-xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-teal-accent/10 -mr-16 -mt-16 rounded-full"></div>
                            <span className="material-symbols-outlined text-teal-accent text-3xl mb-4 relative z-10">policy</span>
                            ...
                            <ul className="space-y-6 relative z-10">
                                ...
                                <li className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-slate-400 font-medium">The EIN on your W-9 must match your Heidi Partner profile.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white border border-slate-200 p-8 rounded-sm text-center">
                            ...
                            <div className="text-[10px] font-black text-[#001A2C] uppercase tracking-tighter">
