    ...
    if (!isAuthenticated) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-white p-6 text-center">
                <span className="material-symbols-outlined text-6xl text-cobalt mb-4 animate-pulse">lock</span>
                ...
                <Link href="/login" className="bg-cobalt text-white px-8 py-4 text-xs font-black uppercase tracking-[0.2em] hover:bg-royal transition-all rounded-sm">
        ...
        <div className="relative flex flex-col min-h-screen w-full overflow-x-hidden bg-[#f1f5f9]">
            ...
            <main className="flex-1 p-8 lg:px-20 max-w-7xl mx-auto w-full">
                <div className="flex items-center justify-between mb-10">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            <span className="bg-cobalt text-white text-[9px] font-black px-2 py-0.5 uppercase rounded-sm">Tier 1 Partner</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                    {[
                        { label: 'Active Quotes', value: '5', icon: 'description', color: 'blue' },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden">
                        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                            ...
                            <button className="text-[10px] font-black text-cobalt uppercase hover:underline">Export Logs</button>
                        </div>
                        <div className="divide-y divide-slate-100">
                            {[
                                { status: 'Delivered', msg: 'HEI-8821 arrived at Atlantic HUB (Dock 4)', time: '2h ago', color: 'blue' },
                                ...
                                <div key={i} className="p-4 flex items-center gap-4 hover:bg-slate-50 transition-colors">
                                    <div className={`w-2 h-2 rounded-full ${activity.color === 'blue' ? 'bg-cobalt' : activity.color === 'blue' ? 'bg-blue-500' : activity.color === 'amber' ? 'bg-amber-500' : 'bg-slate-400'}`}></div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-primary text-white p-6 rounded-sm shadow-xl">
                            ...
                            <div className="space-y-4">
                                <Link href="/ltl-rates" className="flex items-center gap-4 p-3 hover:bg-white/5 transition-colors group">
                                    <span className="material-symbols-outlined text-cobalt">calculate</span>
                                ...
                                <Link href="/catalog" className="flex items-center gap-4 p-3 hover:bg-white/5 transition-colors group">
                                    <span className="material-symbols-outlined text-cobalt">grid_view</span>
                        ...
                        <div className="bg-white border border-slate-200 p-6 rounded-sm shadow-sm relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-24 h-24 bg-cobalt/5 -mr-12 -mt-12 rounded-full transform group-hover:scale-150 transition-transform duration-700"></div>
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center">
                                    <span className="material-symbols-outlined text-cobalt">support_agent</span>
                                </div>
                                <div>
                            ...
                            <button className="w-full py-2.5 bg-slate-50 border border-slate-200 text-[10px] font-black uppercase tracking-widest hover:bg-cobalt hover:text-white hover:border-cobalt transition-all">
                                Connect To Rep
                            </button>
                        </div>
                    </div>
