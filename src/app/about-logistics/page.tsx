                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        ...
                        {operationalFlow.map((flow, idx) => (
                            <div key={idx} className="relative z-10 flex flex-col items-center text-center">
                                <div className="w-24 h-24 rounded-full bg-white border-2 border-slate-100 flex items-center justify-center shadow-sm mb-6 group hover:border-teal-accent transition-colors">
                                    <span className="material-symbols-outlined text-4xl text-teal-accent">{flow.icon}</span>
                                </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start gap-3">
                                        <span className="material-symbols-outlined text-teal-accent mt-1">verified_user</span>
                                        <div>
                                    ...
                                    <li className="flex items-start gap-3">
                                        <span className="material-symbols-outlined text-teal-accent mt-1">precision_manufacturing</span>
                                        <div>
