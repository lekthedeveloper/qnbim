            ...
            <main className="flex-1">
                ...
                <div className="bg-slate-900 py-16 px-10 border-b border-slate-800 relative overflow-hidden">
                    <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-0 right-0 w-96 h-96 bg-cobalt rounded-full blur-[100px] -mr-48 -mt-48"></div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <span className="h-px w-8 bg-cobalt"></span>
                                <span className="text-cobalt text-[11px] font-black uppercase tracking-[0.3em]">Institutional Access</span>
                            </div>
                            <h1 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter" style={{ color: '#FFFFFF' }}>
                                Wholesale <span className="text-cobalt">Procurement</span> Application
                            </h1>
                        ...
                        <div className="bg-slate-50 border-r border-slate-200 p-8 md:p-12 space-y-10">
                            <div>
                                <h3 className="text-xs font-black uppercase tracking-widest text-slate-800 mb-4 flex items-center gap-2">
                                    <span className="material-symbols-outlined text-cobalt text-lg">verified</span>
                                    Verified Accounts
                                </h3>
                                ...
                                <ul className="space-y-3">
                                    {[
                                        ...
                                        <li key={i} className="flex items-center gap-3 text-[11px] font-black text-slate-700 uppercase tracking-widest">
                                            <span className="w-5 h-5 rounded-full bg-cobalt/10 flex items-center justify-center">
                                                <span className="material-symbols-outlined text-[12px] text-cobalt font-bold">check</span>
                                            </span>
                                            {item}
                                        </li>
                                    ))}
                            ...
                            <div className="p-6 bg-slate-900 rounded-sm">
                                <p className="text-[10px] text-cobalt font-black uppercase tracking-widest mb-2 italic">Priority Processing</p>
