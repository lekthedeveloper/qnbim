        ...
        <div className="relative flex flex-col min-h-screen w-full overflow-x-hidden bg-[#f1f5f9]">
            ...
            <main className="flex-1 p-8 lg:px-20">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <nav className="flex text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-2">
                                ...
                                <span className="mx-2">/</span>
                                <span className="text-teal-accent">Quotes</span>
                            </nav>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button className="flex items-center gap-2 bg-teal-accent text-white px-4 py-2 text-xs font-bold uppercase hover:bg-teal-700 transition-colors rounded-sm shadow-sm">
                    ...
                    <div className="mt-12 bg-industrial-gray text-white p-6 flex flex-col md:flex-row items-center justify-between gap-6 border-l-4 border-teal-accent shadow-sm">
                        <div className="flex items-center gap-6">
                            <span className="material-symbols-outlined text-5xl text-teal-accent">pallet</span>
                            <div>
