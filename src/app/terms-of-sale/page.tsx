                        ...
                        <div className="space-y-16">
                            <section id="orders" className="scroll-mt-32">
                                ...
                                <p className="text-sm leading-relaxed text-slate-600 mb-6">
                                    All orders placed through the qnbim Wholesale portal are subject to acceptance by qnbim Wholesale ("the Seller"). We reserve the right to refuse service or cancel orders at our sole discretion, including but not limited to cases of inventory shortages or pricing errors.
                                </p>
                            ...
                            <section id="returns" className="scroll-mt-32">
                                ...
                                <p className="text-sm leading-relaxed text-slate-600 mb-6">
                                    qnbim Wholesale does not accept returns for unsold inventory or "buyer's remorse." All sales are final unless products arrive damaged or there is a verifiable fulfillment error.
                                </p>
                            ...
                            <section id="liability" className="scroll-mt-32">
                                ...
                                <p className="text-sm leading-relaxed text-slate-600 mb-6 font-medium">
                                    IN NO EVENT SHALL qnbim WHOLESALE BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES, INCLUDING LOSS OF PROFITS, REVENUE, OR DATA, INCURRED BY THE BUYER OR ANY THIRD PARTY, WHETHER IN AN ACTION IN CONTRACT OR TORT, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
                                </p>
                                <p className="text-sm leading-relaxed text-slate-600 mb-4">
