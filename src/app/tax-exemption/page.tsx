                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-primary text-white p-8 rounded-sm shadow-xl shadow-primary/10">
                            ...
                            <div className="space-y-1">
                                <p className="text-sm font-black italic tracking-tight">compliance@qnbim.com</p>
                                        ...
                                        <label className="flex items-start gap-5 cursor-pointer">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                                                    I declare under penalty of perjury that the documentation provided is true, correct, and current. I understand that qnbim Wholesale relies on this information for sales tax exemption purposes across state jurisdictions.
                                                </p>
                                            </div>
                                        </label>
                                    </div>
