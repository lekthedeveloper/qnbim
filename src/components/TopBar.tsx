...
const TopBar: React.FC<TopBarProps> = ({ padding = 'px-10', leftContent }) => {
    ...
    return (
        <div className={`bg-deep-slate text-white text-[11px] py-1.5 px-5 md:px-10 flex justify-between items-center font-bold tracking-wider uppercase border-b border-slate-800 sticky top-0 md:relative z-[60]`}>
                ...
                {leftContent || (
                    <>
                        ...
                        <span className="hidden md:flex items-center gap-1">
                            <span className="material-symbols-outlined text-sm text-cobalt">inventory</span>
            ...
            <div className="flex gap-4 md:gap-6 items-center">
                <Link className="hover:text-cobalt transition-colors underline decoration-cobalt whitespace-nowrap" href="/discounts">
