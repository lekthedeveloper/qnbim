        ...
        <div className="space-y-6">
                ...
                <form className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                className="w-full border-slate-200 text-sm font-bold focus:ring-cobalt focus:border-cobalt outline-none border p-2"
                                placeholder="00000"
                                type="text"
                                defaultValue="30303"
                            />
                    ...
                    <button className="w-full bg-slate-900 text-white py-4 font-black text-xs uppercase tracking-widest hover:bg-cobalt transition-all flex items-center justify-center gap-2" type="button">
            ...
            <div className="bg-blue-50 border border-blue-100 p-4">
                <div className="flex gap-3">
                    <span className="material-symbols-outlined text-cobalt text-xl">info</span>
                    <div>
                        <p className="text-xs font-black text-royal uppercase">Volume Discount Alert</p>
                        <p className="text-[11px] text-royal mt-1">
