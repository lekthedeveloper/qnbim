        ...
        <div className="bg-slate-900 border-t border-slate-800 px-6 py-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-7xl mx-auto">
                <div className="flex gap-3 items-start">
                    <span className="material-symbols-outlined text-3xl text-cobalt">local_shipping</span>
                    <div>
                ...
                <div className="flex gap-3 items-start">
                    <span className="material-symbols-outlined text-3xl text-cobalt">inventory_2</span>
                    <div>
                ...
                <div className="flex gap-3 items-start">
                    <span className="material-symbols-outlined text-3xl text-cobalt">receipt_long</span>
                    <div>
                ...
                <div className="flex gap-3 items-start">
                    <span className="material-symbols-outlined text-3xl text-cobalt">support_agent</span>
                    <div>
